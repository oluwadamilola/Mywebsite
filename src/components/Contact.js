              ...
              <ul className="custom-list">
                ...
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">dammyolukoju@gmail.com</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">dammy_codess</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">Oluwadamilola</span>
                  </h6>
                </li>
              </ul>
              ...
              <div className="social">
                ...
                <ul className="list-inline social social-intro text-center p-none">
                  <li className="facebook">
                    <a title="Facebook" href="https://www.linkedin.com/in/olukojudamilola/">
